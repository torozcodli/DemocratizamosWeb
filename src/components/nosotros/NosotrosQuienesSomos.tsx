    ...
    <section id="quienes-somos" className="relative w-full overflow-x-clip">
      <div className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          {/* Columna derecha - Panel con texto */}
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="mt-4 sm:mt-6 md:mt-6 space-y-5 sm:space-y-6 md:space-y-8 max-w-[75ch]">
                <p className="text-[15px] sm:text-[16px] md:text-[17px] xl:text-[18px] leading-relaxed text-[#1E1A49]/75">
                  Democratizamos la Innovación, A.C. se compromete a desafiar los límites del status quo al brindar oportunidades disruptivas de desarrollo personal y comunitario a través de la educación, la capacitación y al fomento a la economía popular a través del emprendimiento.
                </p>
                
                <p className="text-[15px] sm:text-[16px] md:text-[17px] xl:text-[18px] leading-relaxed text-[#1E1A49]/75">
                  Nos enfocamos especialmente en empoderar a las poblaciones en situación de vulnerabilidad, fortaleciendo su capacidad de agencia para impulsar un cambio positivo en sus vidas y en la sociedad en su conjunto.
                </p>
                
                <p className="text-[15px] sm:text-[16px] md:text-[17px] xl:text-[18px] leading-relaxed text-[#1E1A49]/75">
                  Nuestros objetivos son crear igualdad de oportunidades e inspirar la creación de soluciones innovadoras que desafíen las normas establecidas y promuevan una sociedad más justa y equitativa.
                </p>
              </div>
            </div>
          </div>
