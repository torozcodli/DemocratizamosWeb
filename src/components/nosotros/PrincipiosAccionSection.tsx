...
const principleBgColors = ['#4B4A78', '#98A7FF', '#1D194C'];

export async function PrincipiosAccionSection() {
  const t = await getTranslations('nosotros.principios');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div className="pl-6 md:pl-10 lg:pl-12 pr-6">
            <h2 className="font-tech font-extrabold tracking-tight leading-[0.95] text-[#1E1A49] text-[48px] sm:text-[64px] md:text-[72px] lg:text-[84px]">
              ...
              <br />
              <span>{t('title2')}</span>
              <span className="text-[#FF8948]">{t('title3')}</span>
            </h2>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        style={{ backgroundColor: principleBgColors[index] ?? '#1D194C' }}
                      >
