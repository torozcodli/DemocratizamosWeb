  ...
  return (
    <section className="relative w-full bg-[#DEE3FF] py-20 flow-root mt-0">
      <div className="mx-auto max-w-[1400px] px-6">
        {/* Heading */}
        <h2 className="text-center text-5xl sm:text-6xl lg:text-7xl leading-[0.95]">
        ...
        {/* Subtitle */}
        <p className="mt-6 text-center text-base sm:text-lg md:text-xl font-semibold text-[#1E1A49]/80">
